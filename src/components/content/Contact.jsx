          ...
          <p className="text-xl font-semibold text-blue-600 pt-4" > 
            <a className="after:content-['_↗']" href="https://www.linkedin.com/in/vighanesh-sharma-002826140/" target="_blank">
              <button className="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                <svg className="w-5 h-5 fill-current" role="img" viewBox="0 0 256 256" xmlnsXlink="http://www.w3.org/2000/svg">
